              ...
              <div class="md:w-2/3 flex flex-col justify-between">
                ...
                <div class="space-y-2">
                  ...
                  {props.data.result.videoSD && (
                    <button
                      class="download-button bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-500 hover:to-blue-300 w-full p-3 rounded-lg text-white font-semibold flex items-center justify-center cursor-pointer"
                  ...
                  {(props.data.result.videoHD || props.data.result.video_hd) && (
                    <button
                      class="download-button bg-gradient-to-r from-pink-600 to-pink-400 hover:from-pink-500 hover:to-pink-300 w-full p-3 rounded-lg text-white font-semibold flex items-center justify-center cursor-pointer"
                      onClick={() => props.onDownloadClick(
                  ...
                  {props.data.result.videoWatermark && (
                    <button
                      class="download-button bg-gradient-to-r from-green-600 to-green-400 hover:from-green-500 hover:to-green-300 w-full p-3 rounded-lg text-white font-semibold flex items-center justify-center cursor-pointer"
                      onClick={() => props.onDownloadClick(
                  ...
                  {props.data.result.music && (
                    <button
                      class="download-button bg-gradient-to-r from-yellow-600 to-yellow-400 hover:from-yellow-500 hover:to-yellow-300 w-full p-3 rounded-lg text-white font-semibold flex items-center justify-center cursor-pointer"
                      onClick={() => props.onDownloadClick(
                  ...
                  {/* Download Another */}
                  <button class="download-button bg-gradient-to-r from-purple-600 to-purple-400 hover:from-purple-500 hover:to-purple-300 w-full p-3 rounded-lg text-white font-semibold flex items-center justify-center cursor-pointer">
