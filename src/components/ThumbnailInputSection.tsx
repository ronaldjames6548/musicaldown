          ...
          >
            <div class="relative flex-grow rounded bg-white">
              ...
              <button type="button" 
                ...
                class="absolute right-3 top-1/2 transform -translate-y-1/2 bg-linear-to-r from-purple-500 to-pink-500 text-white rounded-md hover:opacity-90 transition-opacity flex items-center gap-2 text-white px-4 py-3 rounded">
