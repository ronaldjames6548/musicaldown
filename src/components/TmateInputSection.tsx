          ...
          >
            <div class="relative flex-grow bg-white">
              <input type="text"
                ...
                placeholder="Paste TikTok video link here (we'll extract the URL automatically)"
              ...
              <button type="button" 
                ...
                class="absolute right-3 top-1/2 transform -translate-y-1/2 bg-blue-100 text-cyan-700 text-base rounded px-2 py-2 transition-all duration-300 flex items-center">
            ...
            <button type="submit" 
              ...
              class="h-14 px-8 bg-slate-700 disabled:from-gray-500 disabled:to-gray-400 text-lg text-white font-medium flex items-center justify-center gap-2 disabled:transform-none disabled:cursor-not-allowed">
              {props.loading ? (
                <>
                ...
                Download
				  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256">
					<path fill="#fff" d="M74.34 85.66a8 8 0 0 1 11.32-11.32L120 108.69V24a8 8 0 0 1 16 0v84.69l34.34-34.35a8 8 0 0 1 11.32 11.32l-48 48a8 8 0 0 1-11.32 0ZM240 136v64a16 16 0 0 1-16 16H32a16 16 0 0 1-16-16v-64a16 16 0 0 1 16-16h52.4a4 4 0 0 1 2.83 1.17L111 145a24 24 0 0 0 34 0l23.8-23.8a4 4 0 0 1 2.8-1.2H224a16 16 0 0 1 16 16m-40 32a12 12 0 1 0-12 12a12 12 0 0 0 12-12"/>
				  </svg>
                </>
              )}
            </button>
