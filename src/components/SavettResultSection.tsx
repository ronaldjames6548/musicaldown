  ...
  return (
    <div class="mt-6 w-full max-w-4xl mx-auto">
        ...
        <div class="relative z-10 flex flex-col md:flex-row gap-4">
          ...
          <div class="w-full md:w-64 flex flex-col gap-2 z-20">
            ...
            {props.data.result.videoSD && (
              <button
                class="download-button custom-gradient w-full p-3 rounded text-white font-bold flex items-center justify-center cursor-pointer"
      ...
      <div class="mt-4">
        <a 
          href="/" 
          class="block w-full bg-[#000000] hover:bg-grey-950 text-white text-center py-3 rounded-none md:rounded text-lg font-normal no-underline transition-colors"
        >
