  ...
  return (
    <div class="mt-6 w-full max-w-4xl mx-auto">
        ...
        <div class="relative z-10 flex flex-col md:flex-row gap-4">
          ...
          <div class="w-full md:w-64 flex flex-col gap-2 z-20">
            ...
            {props.data.result.videoSD && (
              <button
                class="w-full bg-[#E14147] hover:bg-red-700 text-white font-medium py-2 px-4 rounded flex items-center justify-center gap-2 transition-colors shadow-sm"
      ...
      <div class="mt-4">
        <a 
          href="/" 
          class="block w-full bg-[#B8353A] hover:bg-red-500 text-white text-center py-3 rounded-none md:rounded text-sm font-normal no-underline transition-colors"
        >
