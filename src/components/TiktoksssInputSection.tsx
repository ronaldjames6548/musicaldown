          ...
          >
            <div class="relative flex-grow bg-white">
              ...
              <button type="button" 
                ...
                class="absolute right-3 top-1/2 is-paste transform -translate-y-1/2 bg-blue-100 text-cyan-700 text-base px-4 py-2 transition-all duration-300 flex items-center">
                <i class="lt-icon img-paste"></i>
              </button>
            </div>
            <button type="submit" 
              disabled={props.loading || props.autoProcessing}
              class="h-14 px-8 bg-sky-500 disabled:from-gray-500 disabled:to-gray-400 text-lg text-white font-medium flex items-center justify-center gap-2 disabled:transform-none disabled:cursor-not-allowed">
              {props.loading ? (
                <>
